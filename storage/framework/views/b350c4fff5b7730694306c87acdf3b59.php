        ...
        <div class="bg-white rounded-lg shadow p-8">
            ...
            <div class="mb-4 flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-lg font-bold text-gray-900"><?php echo e($task->startup->company_name); ?></p>
                </div>
            </div>
                        ...
                        <?php else: ?>
                            ...
                            <div class="border border-gray-200 rounded-lg p-5 mb-4">
                                <div class="flex items-start justify-between mb-3">
                                    ...
                                    <span class="px-3 py-1 text-xs font-medium rounded-full <?php echo e($application->status === 'approved' ? 'bg-green-100 text-green-800' : ($application->status === 'rejected' ? 'bg-red-100 text-red-800' : 'bg-yellow-100 text-yellow-800')); ?>">
                                ...
                                <?php if($application->status === 'applied'): ?>
                                    <div class="flex gap-2">
                                        <form method="POST" action="<?php echo e(route('startup.applications.approve', $application->id)); ?>">
                                            <?php echo csrf_field(); ?>
                                            <button class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 text-sm font-medium">Approve Application</button>
                                        </form>
                                        <form method="POST" action="<?php echo e(route('startup.applications.reject', $application->id)); ?>">
                                            <?php echo csrf_field(); ?>
                                            <button class="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 text-sm font-medium">Reject Application</button>
                                        </form>
                                    </div>
                                <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\InternGrowth\InternGrowth\resources\views/tasks/show.blade.php ENDPATH**/ ?>