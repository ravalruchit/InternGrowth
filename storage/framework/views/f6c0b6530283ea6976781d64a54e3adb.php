...
<?php if(auth()->check() && auth()->user()->isStudent()): ?>
            ...
            <div class="flex flex-col md:flex-row gap-6 items-start relative z-10">
                ...
                <div class="flex-1 space-y-5">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-white/5 border border-white/10 rounded-2xl p-4 text-center">
                        <div>
                            <span class="block text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[var(--ig-accent)] to-[var(--ig-accent-soft)]"><?php echo e($iprs); ?></span>
                            <span class="text-[9px] font-bold text-[var(--ig-accent-soft)] uppercase tracking-wider">Current IPRS</span>
                        </div>
                        <div>
                            <span class="block text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[var(--ig-accent)] to-[var(--ig-accent-soft)]"><?php echo e($verifiedTasks); ?></span>
                            <span class="text-[9px] font-bold text-[var(--ig-accent-soft)] uppercase tracking-wider">Verified Tasks</span>
                        </div>
                        <div>
                            <span class="block text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[var(--ig-accent)] to-[var(--ig-accent-soft)]"><?php echo e($reviewsCount); ?></span>
                            <span class="text-[9px] font-bold text-[var(--ig-accent-soft)] uppercase tracking-wider">Startup Reviews</span>
                        </div>
                        <div>
                            <span class="block text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[var(--ig-accent)] to-[var(--ig-accent-soft)]"><?php echo e($internshipOffers); ?></span>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\Users\Raval Ruchit\Desktop\interndesign\InternGrowth\resources\views/components/reputation-card.blade.php ENDPATH**/ ?>