    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5">
        ...
        <div>
            ...
            <input id="email" name="email" type="email" required autofocus autocomplete="username"
                   value="<?php echo e(old('email')); ?>" placeholder="you@college.edu"
                   class="ig-input" />
        ...
        <div>
            <div class="flex items-center justify-between mb-2">
                ...
                <?php if(Route::has('password.request')): ?>
                    <a href="<?php echo e(route('password.request')); ?>" class="text-[12px] text-[var(--ig-muted)] hover:text-[var(--ig-accent)] font-medium">Forgot?</a>
                <?php endif; ?>
            </div>
...
<?php endif; ?>
        ...
        <p class="text-center text-sm text-[var(--ig-muted)] pt-2">
            New to InternGrowth? <a href="<?php echo e(route('register')); ?>" class="font-semibold text-[var(--ig-ink)] hover:text-[var(--ig-accent)]">Create an account →</a>
        </p>
    </form>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Raval Ruchit\Desktop\interndesign\InternGrowth\resources\views/auth/login.blade.php ENDPATH**/ ?>