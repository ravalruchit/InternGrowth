...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px;">
        <h2 style="color: #1f2937; margin-top: 0;">Hello <?php echo e($profile->user->name); ?>!</h2>
        ...
        <div style="background: white; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #667eea;">
            <p style="margin: 0; color: #6b7280; font-size: 14px;">College: <strong style="color: #1f2937;"><?php echo e($profile->college_name); ?></strong></p>
            <p style="margin: 10px 0 0 0; color: #6b7280; font-size: 14px;">Email: <strong style="color: #1f2937;"><?php echo e($profile->college_email); ?></strong></p>
        </div>
        ...
        <p style="color: #9ca3af; font-size: 12px; text-align: center; margin: 0;">
            © <?php echo e(date('Y')); ?> InternGrowth. All rights reserved.<br>
            This is an automated email, please do not reply.
        </p>
    </div>
</body>
</html>
<?php /**PATH D:\InternGrowth\InternGrowth\resources\views/emails/student-verification-code.blade.php ENDPATH**/ ?>