    ...
    <div class="min-h-screen grid grid-cols-1 lg:grid-cols-2 relative">
        ...
        <aside class="hidden lg:flex flex-col justify-between bg-[var(--ig-surface-ink)] text-white p-12 relative overflow-hidden">
            ...
            <div class="relative flex items-center gap-6 text-[12px]" style="color:#9C9580">
                <span class="ig-mono">© <?php echo e(date('Y')); ?></span>
                <a href="<?php echo e(route('privacy')); ?>" class="hover:text-[var(--ig-lime)] transition">Privacy</a>
                <a href="<?php echo e(route('terms')); ?>" class="hover:text-[var(--ig-lime)] transition">Terms</a>
            </div>
        </aside>
...
</html><?php /**PATH C:\Users\Raval Ruchit\Desktop\interndesign\InternGrowth\resources\views/layouts/guest.blade.php ENDPATH**/ ?>