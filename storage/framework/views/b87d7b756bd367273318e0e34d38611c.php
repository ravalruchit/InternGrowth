            ...
            <div class="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            <h1 class="text-2xl sm:text-3xl font-black text-white tracking-tight"><?php echo e($profile->user->name); ?></h1>
                            ...
                            <div class="flex flex-wrap items-center gap-2 mt-2">
                                ...
                                <?php if($profile->college_name): ?>
                                    <span class="text-xs text-slate-500 font-medium"><?php echo e($profile->college_name); ?></span>
                                <?php endif; ?>
                            </div>

                            <?php if($profile->bio): ?>
                                <p class="text-sm text-slate-400 mt-3 max-w-lg leading-relaxed"><?php echo e($profile->bio); ?></p>
                            <?php endif; ?>

                            <p class="text-[11px] text-slate-600 mt-2 font-medium">Member since <?php echo e($profile->created_at->format('M Y')); ?></p>
                        </div>
                    </div>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 -mt-4">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-5 gap-3 sm:gap-4 mb-8">
                ...
                <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-slate-900/80 backdrop-blur-sm border border-slate-800/80 rounded-2xl p-4 sm:p-5 text-center hover:border-<?php echo e($stat['color']); ?>-500/30 transition-all duration-300 group">
                        <div class="text-2xl mb-2 group-hover:scale-110 transition-transform duration-200"><?php echo e($stat['icon']); ?></div>
                        <div class="text-xl sm:text-2xl font-black text-white tracking-tight"><?php echo e($stat['value']); ?></div>
                        <div class="text-[10px] sm:text-xs text-slate-500 font-semibold uppercase tracking-wider mt-1"><?php echo e($stat['label']); ?></div>
                    </div>
                            ...
                            <?php $__currentLoopData = $metrics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metric): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div>
                                    <div class="flex justify-between text-xs font-medium mb-1">
                                        <span class="text-slate-400"><?php echo e($metric['label']); ?></span>
                                        <span class="text-white font-semibold"><?php echo e($metric['value']); ?>%</span>
                                    </div>
                                    <div class="w-full bg-slate-800 rounded-full h-1.5 overflow-hidden">
                                        <div class="bg-<?php echo e($metric['color']); ?>-500 h-1.5 rounded-full transition-all duration-700" style="width: <?php echo e(min($metric['value'], 100)); ?>%"></div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($score && $score->interviews_attended > 0): ?>
                                <div class="grid grid-cols-2 gap-2 text-[11px] bg-slate-900 border border-slate-800/80 rounded-xl p-3 text-slate-400 mt-2">
                                    <div>
                                        ...
                                        <span class="font-bold text-white"><?php echo e($score->interviews_attended); ?></span>
                                    </div>
                                    <div>
                                        <span class="block text-slate-500 font-medium">Success Rate</span>
                                        <span class="font-bold text-white"><?php echo e(number_format($score->interview_success_rate, 0)); ?>%</span>
                                    </div>
                                    <div>
                                        <span class="block text-slate-500 font-medium">Strong Outcomes</span>
                                        <span class="font-bold text-white"><?php echo e($score->strong_candidate_outcomes); ?></span>
                                    </div>
                                    <div>
                                        <span class="block text-slate-500 font-medium">No Shows</span>
                                        <span class="font-bold <?php echo e($score->no_shows > 0 ? 'text-rose-400' : 'text-white'); ?>"><?php echo e($score->no_shows); ?></span>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                                ...
                                <?php if($isVerified): ?>
                                    <div class="flex items-center justify-between bg-indigo-500/5 border border-indigo-500/15 rounded-xl px-4 py-3 group hover:border-indigo-500/30 transition-all duration-200">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <span class="text-sm font-semibold text-white"><?php echo e($skill->name); ?></span>
                                        </div>
                                ...
                                <?php else: ?>
                                    <div class="flex items-center justify-between bg-slate-800/30 border border-slate-800/50 rounded-xl px-4 py-3">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <span class="text-sm font-medium text-slate-500"><?php echo e($skill->name); ?></span>
                                        </div>
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        ...
                        <span class="text-xs text-indigo-400 font-bold bg-indigo-500/10 border border-indigo-500/20 px-3 py-1.5 rounded-full">
                            <?php echo e($portfolio->items->count()); ?> Verified <?php echo e(Str::plural('Project', $portfolio->items->count())); ?>
                        ...
                        <div class="space-y-5">
                            <?php $__currentLoopData = $portfolio->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="bg-slate-900/80 border border-slate-800/80 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl hover:border-slate-700/60 transition-all duration-300 group backdrop-blur-sm">
                                    <!-- Top edge accent -->
                                    <div class="h-1 bg-gradient-to-r from-<?php echo e($badge['color']); ?>-500 to-<?php echo e($badge['color']); ?>-600"></div>

                                    <div class="p-6">
                                        <!-- Header Row -->
                                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-4">
                                            <div>
                                                <h3 class="text-lg font-black text-white tracking-tight group-hover:text-indigo-300 transition-colors duration-200"><?php echo e($item->startup_name); ?></h3>
                                                <p class="text-xs font-semibold text-slate-500 mt-1 uppercase tracking-wider"><?php echo e($item->project_title); ?></p>
                                            </div>

                                            <div class="flex items-center gap-2 flex-shrink-0">
                                                <!-- Verification Badge -->
                                                <span class="inline-flex items-center px-3 py-1 rounded-xl text-xs font-bold bg-<?php echo e($badge['color']); ?>-500/10 text-<?php echo e($badge['color']); ?>-400 border border-<?php echo e($badge['color']); ?>-500/20">
                                                ...
                                                <?php if($item->rating_received): ?>
                                                    <span class="inline-flex items-center px-2.5 py-1 rounded-xl text-xs font-bold bg-amber-500/10 text-amber-400 border border-amber-500/20">
                                                        ⭐ <?php echo e(number_format($item->rating_received, 1)); ?>/5
                                                    </span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-slate-800/30 border border-slate-800/50 rounded-xl p-4 mb-4 text-sm">
                                            ...
                                            <div>
                                                ...
                                                <span class="text-xs font-bold text-slate-300"><?php echo e($item->completed_at ? $item->completed_at->format('M d, Y') : $item->created_at->format('M d, Y')); ?></span>
                                            </div>
                                            <div>
                                        ...
                                        <!-- Auto Summary -->
                                        <p class="text-sm text-slate-400 leading-relaxed mb-4"><?php echo e($item->auto_summary); ?></p>
                                            ...
                                            <div class="bg-slate-800/30 border border-slate-800/50 rounded-xl p-4 mb-4">
                                                ...
                                                <div class="flex flex-wrap gap-3">
                                                    <?php if($item->github_url): ?>
                                                        <a href="<?php echo e($item->github_url); ?>" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-slate-800 border border-slate-700 text-xs font-bold text-slate-300 hover:text-white hover:border-slate-600 transition-all duration-200">
                                                    ...
                                                    <?php if($item->demo_url): ?>
                                                        <a href="<?php echo e($item->demo_url); ?>" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-slate-800 border border-slate-700 text-xs font-bold text-slate-300 hover:text-white hover:border-slate-600 transition-all duration-200">
                                                    ...
                                                    <div class="flex flex-wrap gap-2 mt-3">
                                                        <?php $__currentLoopData = $item->screenshots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $screenshot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if(isset($screenshot['path'])): ?>
                                                                <a href="<?php echo e(asset('storage/' . $screenshot['path'])); ?>" target="_blank" class="block w-16 h-16 rounded-lg overflow-hidden border border-slate-700 hover:border-indigo-500 transition-all duration-200">
                                                                    <img src="<?php echo e(asset('storage/' . $screenshot['path'])); ?>" alt="<?php echo e($screenshot['name'] ?? 'Screenshot'); ?>" class="w-full h-full object-cover">
                                                                </a>
                                                            <?php endif; ?>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </div>
                                        ...
                                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 border-t border-slate-800/50 pt-4">
                                            <div class="flex flex-wrap gap-1.5">
                                                <?php $__currentLoopData = $item->skills_demonstrated ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skillName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <span class="bg-slate-800/80 text-slate-400 text-[10px] font-semibold px-2.5 py-1 rounded-lg border border-slate-700/50"><?php echo e($skillName); ?></span>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>

                                            <?php if($item->certificate_number): ?>
                                                <a href="<?php echo e(route('certificates.verify', $item->certificate_number)); ?>" target="_blank" class="inline-flex items-center text-xs text-indigo-400 hover:text-indigo-300 font-bold transition gap-1">
                                                    📜 View Certificate
...
<?php endif; ?>
<?php /**PATH C:\Users\Raval Ruchit\Desktop\InternGrowth\InternGrowth\resources\views/student/talent-profile.blade.php ENDPATH**/ ?>