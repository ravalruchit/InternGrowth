                ...
                <div class="flex justify-between h-20">
                    <div class="flex items-center group">
                        <div class="relative">
                            ...
                            <img src="{{ asset('images/logo.png') }}" alt="InternGrowth" class="h-16 w-auto relative z-10 transform group-hover:scale-110 transition-all duration-300 drop-shadow-2xl">
                        </div>
                    ...
                    <div class="flex items-center space-x-4">
                        @auth
                            <a href="{{ route('dashboard') }}" class="group relative px-6 py-2.5 rounded-xl text-white font-semibold overflow-hidden transform hover:scale-105 transition-all duration-300 shadow-lg">
                                <span class="absolute inset-0 bg-gradient-to-r from-indigo-600 to-purple-600"></span>
                                <span class="relative">Dashboard</span>
                            </a>
                        @else
                            <a href="{{ route('login') }}" class="text-gray-700 hover:text-indigo-600 px-4 py-2 rounded-lg font-medium transition-all duration-300">Login</a>
                            <a href="{{ route('register') }}" class="group relative px-6 py-2.5 rounded-xl text-white font-semibold overflow-hidden transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-2xl">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <div class="text-center mb-20 animate-slide-up">
                    ...
                    <div class="flex justify-center gap-6 animate-fade-in" style="animation-delay: 0.4s;">
                        <a href="{{ route('register') }}" class="group relative px-10 py-4 rounded-2xl text-white text-lg font-bold overflow-hidden transform hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-indigo-500/50">
                            <span class="absolute inset-0 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 animate-gradient bg-[length:200%_200%]"></span>
                        ...
                        <a href="{{ route('tasks.index') }}" class="group px-10 py-4 rounded-2xl text-indigo-600 text-lg font-bold border-4 border-indigo-600 hover:bg-indigo-600 hover:text-white transition-all duration-300 transform hover:scale-105 shadow-xl">
                ...
                <div class="relative bg-animated-gradient rounded-3xl p-16 text-center overflow-hidden shadow-2xl animate-scale-in" style="animation-delay: 0.5s;">
                    ...
                    <div class="relative z-10">
                        ...
                        <a href="{{ route('register') }}" class="group inline-block bg-white text-indigo-600 px-12 py-5 rounded-2xl text-xl font-bold hover:bg-gray-100 transform hover:scale-110 transition-all duration-300 shadow-2xl">
