                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="bio" rows="4" 
                                  class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 transition">{{ old('bio', $student->studentProfile->bio ?? '') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="education" rows="3" 
                                  class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 transition">{{ old('education', $student->studentProfile->education ?? '') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="experience" rows="3" 
                                  class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 transition">{{ old('experience', $student->studentProfile->experience ?? '') }}</textarea>
                    </div>
                </div>
