...
<body class="font-sans antialiased bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 min-h-screen relative overflow-x-hidden">
                    ...
                    <div class="flex items-center space-x-8">
                        ...
                        <div class="flex items-center group">
                            <div class="relative">
                                ...
                                <img src="{{ asset('images/logo.png') }}" alt="InternGrowth" class="h-14 w-auto relative z-10 transform group-hover:scale-110 transition-all duration-300 drop-shadow-2xl">
                            </div>
                        ...
                        <div class="hidden md:flex space-x-2">
                            <a href="{{ route('dashboard') }}" class="group relative px-4 py-2 rounded-xl text-gray-700 hover:text-white font-medium transition-all duration-300 overflow-hidden">
                            ...
                            <a href="{{ route('tasks.index') }}" class="group relative px-4 py-2 rounded-xl text-gray-700 hover:text-white font-medium transition-all duration-300 overflow-hidden">
                            ...
                            <a href="{{ route('leaderboard') }}" class="group relative px-4 py-2 rounded-xl text-gray-700 hover:text-white font-medium transition-all duration-300 overflow-hidden">
                            ...
                            @if(auth()->user()->isStudent())
                                <a href="{{ route('student.analytics') }}" class="group relative px-4 py-2 rounded-xl text-gray-700 hover:text-white font-medium transition-all duration-300 overflow-hidden">
                            ...
                            <div class="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl border border-purple-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform origin-top-right scale-95 group-hover:scale-100 z-50">
                                <div class="py-2">
                                    @if(auth()->user()->role === 'student')
                                        <a href="{{ route('student.profile') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 transition-all duration-200">
                                            <svg class="w-5 h-5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    @elseif(auth()->user()->role === 'startup')
                                        <a href="{{ route('startup.profile') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 transition-all duration-200">
                                            <svg class="w-5 h-5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div id="message-sent-notification" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 animate-slide-down">
                <div class="bg-gradient-to-r from-blue-50 to-cyan-50 border-l-4 border-blue-500 text-blue-800 px-6 py-4 rounded-2xl shadow-xl flex items-center justify-between transform hover:scale-105 transition-all duration-300">
                    <div class="flex items-center space-x-4">
                        ...
                        <p class="font-semibold text-lg">{{ session('message_sent') }}</p>
                    </div>
            ...
            <div id="task-created-notification" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 animate-slide-down">
                <div class="bg-gradient-to-r from-purple-50 to-pink-50 border-l-4 border-purple-500 text-purple-800 px-6 py-4 rounded-2xl shadow-xl flex items-center justify-between transform hover:scale-105 transition-all duration-300">
                    <div class="flex items-center space-x-4">
                        ...
                        <p class="font-semibold text-lg">{{ session('task_created') }}</p>
                    </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <div class="space-y-4 animate-slide-up" style="animation-delay: 0.1s;">
                        <div class="flex items-center space-x-3 group">
                            <div class="relative">
                                ...
                                <!-- Logo without background -->
                                <img src="{{ asset('images/logo.png') }}" alt="InternGrowth" class="h-12 w-auto relative z-10 transform group-hover:scale-110 transition-all duration-300 drop-shadow-lg">
                            </div>
                    ...
                    <div class="animate-slide-up" style="animation-delay: 0.2s;">
                        ...
                        <ul class="space-y-3">
                            <li><a href="{{ route('tasks.index') }}" class="text-gray-600 hover:text-indigo-600 transition text-sm flex items-center space-x-2 group">
                                <span class="w-0 group-hover:w-2 h-0.5 bg-indigo-600 transition-all duration-300"></span>
                                <span>Browse Tasks</span>
                            </a></li>
                            <li><a href="{{ route('leaderboard') }}" class="text-gray-600 hover:text-indigo-600 transition text-sm flex items-center space-x-2 group">
                                <span class="w-0 group-hover:w-2 h-0.5 bg-indigo-600 transition-all duration-300"></span>
                                <span>Leaderboard</span>
                            </a></li>
                            <li><a href="{{ route('dashboard') }}" class="text-gray-600 hover:text-indigo-600 transition text-sm flex items-center space-x-2 group">
                                <span class="w-0 group-hover:w-2 h-0.5 bg-indigo-600 transition-all duration-300"></span>
                                <span>Dashboard</span>
                            </a></li>
                            @auth
                            <li><a href="{{ route('report.show') }}" class="text-red-600 hover:text-red-800 transition text-sm flex items-center space-x-2 group font-semibold">
                    ...
                    <div class="animate-slide-up" style="animation-delay: 0.3s;">
                        ...
                        <ul class="space-y-3">
                            <li><a href="{{ route('privacy') }}" class="text-gray-600 hover:text-purple-600 transition text-sm flex items-center space-x-2 group">
                                <span class="w-0 group-hover:w-2 h-0.5 bg-purple-600 transition-all duration-300"></span>
                                <span>Privacy Policy</span>
                            </a></li>
                            <li><a href="{{ route('terms') }}" class="text-gray-600 hover:text-purple-600 transition text-sm flex items-center space-x-2 group">
                                <span class="w-0 group-hover:w-2 h-0.5 bg-purple-600 transition-all duration-300"></span>
                            ...
                            <li><a href="{{ route('contact') }}" class="text-gray-600 hover:text-purple-600 transition text-sm flex items-center space-x-2 group">
                                <span class="w-0 group-hover:w-2 h-0.5 bg-purple-600 transition-all duration-300"></span>
    ...
    <script>
        // ── Notification Bell ──────────────────────────────────────────────
        const NOTIF_URL   = '{{ route("notifications.unread-count") }}';
        ...
        async function loadNotifDropdown() {
            try {
                const res  = await fetch('{{ url("/notifications") }}?dropdown=1', {
        ...
        async function fetchDropdownNotifs() {
            try {
                const res  = await fetch('{{ url("/notifications/dropdown") }}', {
                    headers: { 'X-Requested-With': 'XMLHttpRequest' }
                });
                if (!res.ok) return;
                const data = await res.json();
